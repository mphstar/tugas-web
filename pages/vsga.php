...
<body>
        ...
        <div id="sidebar" class="active">
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    ...
                    <ul class="menu">
                        <li class="sidebar-item ">
                            <a href="multiple_upload.php" name="logout" class='sidebar-link'>
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>DTS VSGA</h3>
                        <p class="text-subtitle text-muted">List Data Table DTS VSGA</p>
                    </div>
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="../index.php">Dashboard</a></li>
                                <li class="breadcrumb-item active" aria-current="page">DTS VSGA</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                                ...
                                                <div class="modal fade text-left" id="updateuser<?php echo $idval; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="crudvsga.php?id=<?php echo $idval; ?>" method="POST">
                                                                <div class="modal-body">
                                                                    <label>Nama: </label>
                                                                    <div class="form-group">
                                                                        <input type="text" name="txt_nama" value="<?php echo $nama; ?>" placeholder="Nama" class="form-control" required>
                                                                    </div>
                                                                    <label>Tanggal Lahir: </label>
                                                                    <div class="form-group">
                                                                        <input type="date" name="txt_tgl" value="<?php echo $tgllahir; ?>" placeholder="Tanggal Lahir" class="date form-control" required>
                                                                    </div>
                                                                    <label>Email: </label>
                                                                    <div class="form-group">
                                                                        <input type="text" name="txt_email" value="<?php echo $emailval; ?>" placeholder="Email" class="form-control" required>
                                                                    </div>
                                                                    <label>No Telepon: </label>
                                                                    <div class="form-group">
                                                                        <input type="text" name="txt_nohp" value="<?php echo $notelepon; ?>" placeholder="No Telepon" class="form-control" required>
                                                                    </div>
                                                                    <label>Alamat: </label>
                                                                    <div class="form-group">
                                                                        <input type="text" name="txt_alamat" value="<?php echo $alamat; ?>" placeholder="Alamat" class="form-control" required>
                                                                    </div>
                                                                    <label>Jenis Kelamin: </label>
                                                                    <div class="form-group">
                                                                        <select name="txt_jeniskelamin" class="form-select">
                                                ...
                                                <div class="modal fade text-left" id="deletedata<?php echo $idval; ?>" tabindex="-1" aria-labelledby="myModalLabel120" style="display: none;" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="crudvsga.php?id=<?php echo $idval; ?>" method="POST">
                                                                <div class="modal-body">
                                                                    Apakah anda yakin ingin menghapus data <b><?php echo $nama; ?></b>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-light-secondary" data-bs-dismiss="modal">
                                                                        <i class="bx bx-x d-block d-sm-none"></i>
                            ...
                            <div class="modal fade text-left" id="tambahdata" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="crudvsga.php" method="POST">
                                            <div class="modal-body">
                                                <label>Nama: </label>
                                                <div class="form-group">
                                                    <input type="text" name="txt_nama" placeholder="Nama" class="form-control" required>
                                                </div>
                                                <label>Tanggal Lahir: </label>
                                                <div class="form-group">
                                                    <input type="date" name="txt_tgl" placeholder="Tanggal Lahir" class="date form-control" required>
                                                </div>
                                                <label>Email: </label>
                                                <div class="form-group">
                                                    <input type="text" name="txt_email" placeholder="Email" class="form-control" required>
                                                </div>
                                                <label>No Telepon: </label>
                                                <div class="form-group">
                                                    <input type="text" name="txt_nohp" placeholder="No Telepon" class="form-control" required>
                                                </div>
                                                <label>Alamat: </label>
                                                <div class="form-group">
                                                    <input type="text" name="txt_alamat" placeholder="Alamat" class="form-control" required>
                                                </div>
                                                <label>Jenis Kelamin: </label>
                                                <div class="form-group">
                                                    <select name="txt_jeniskelamin" class="form-select">
    ...
    <?php if (isset($_SESSION['flashDataError'])) {
    ?> <script>
            Swal.fire(
                'Gagal',
                '<?php echo $_SESSION['flashDataError']; ?>',
                'error'
            )
        </script><?php unset($_SESSION['flashDataError']);
                } ?>
