            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>File Uploader</h3>
                        <p class="text-subtitle text-muted">Upload Multiple Image to Database</p>
                    </div>
                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Upload Multifile PHP</h5>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <p class="card-text">You can Upload Multiple File in Here..
                                </p>
